...
Input_video="Night Time Traffic Camera video.mp4"

output_video="Night Time Traffic Camera_output.mp4"	
path = "yolo-coco"
...
def initializeVideoWriter(video_width, video_height, videoStream):
	...
	return cv2.VideoWriter(output_video, fourcc, sourceVideofps,
